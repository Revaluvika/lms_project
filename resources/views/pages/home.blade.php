...
<section class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-24">
  <div class="max-w-7xl mx-auto text-center px-6">
    ...
    <a href="{{ route('login.role', ['role' => 'siswa']) }}" class="bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold hover:bg-blue-100 transition">
      Mulai Sekarang
    </a>
  </div>
</section>
  ...
  <div class="max-w-6xl mx-auto px-6 text-center">
    ...
    <div class="grid md:grid-cols-3 gap-10">
      <div class="bg-white p-8 rounded-2xl shadow hover:shadow-lg transition">
        <img src="{{ asset('assets/icons/classroom.svg') }}" alt="Kelas Digital" class="w-16 mx-auto mb-4">
      ...
      <div class="bg-white p-8 rounded-2xl shadow hover:shadow-lg transition">
        <img src="{{ asset('assets/icons/report.svg') }}" alt="Pelaporan Otomatis" class="w-16 mx-auto mb-4">
      ...
      <div class="bg-white p-8 rounded-2xl shadow hover:shadow-lg transition">
        <img src="{{ asset('assets/icons/parents.svg') }}" alt="Monitoring Orang Tua" class="w-16 mx-auto mb-4">
...
<section class="bg-blue-600 py-20 text-white">
  <div class="max-w-5xl mx-auto text-center">
    ...
    <a href="{{ route('login.role', ['role' => 'kepala-sekolah']) }}" class="bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold hover:bg-blue-100 transition">
      Daftar Sekarang
    </a>
  </div>
</section>
...
<footer class="bg-gray-900 text-gray-300 py-10">
  <div class="max-w-6xl mx-auto px-6 text-center">
    ...
    <p class="mb-6 text-gray-400">© {{ date('Y') }} LearnFlux. Semua Hak Dilindungi.</p>
